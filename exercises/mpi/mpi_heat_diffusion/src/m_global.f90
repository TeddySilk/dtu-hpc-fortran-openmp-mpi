MODULE m_global
   ...
   LOGICAL   :: benchmark                       ! benchmark: .TRUE.: benchmarking is performed and output
   ...
   CHARACTER(LEN = 24)    :: benchmark_file         ! benchmark_file: Name of the benchmark file for CPU times
